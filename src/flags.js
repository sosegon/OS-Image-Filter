...
CSS_CLASS_PAYPAL_DONATION = 'skf-paypal-donation';
CSS_CLASS_BACKGROUND_PATTERN = 'skf-background-pattern-image';
CSS_CLASS_BACKGROUND_LIGHT_PATTERN = 'skf-background-light-pattern-image';